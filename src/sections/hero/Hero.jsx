  ...
  return (
    <>
      <section
        ...
        className={`mobile-hero-height md:section-height mx-auto flex items-center justify-items-start bg-black bg-[url('./body_hero.webp')] bg-[length:auto_80%] bg-[100%_0%] bg-no-repeat md:max-w-2xl md:bg-[length:auto_70%] md:bg-[80%_50%] lg:max-w-4xl lg:bg-[length:auto_100%]`}
      >
